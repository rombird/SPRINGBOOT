...
@Configuration
@EntityScan(basePackages = {"com.example.demo.Domain.Common.Entity"})  // Entity가 있는 패키지 경로
@EnableJpaRepositories(basePackages = {"com.example.demo.Domain.Common.Repository"}) // JPA Repository 있는 위치 경로
